...
const hypotheses = [{
  ...
  experiments: [{
    ...
    steps: ['Setup Clay.com o Apollo.io: conectar LinkedIn Sales Navigator para enriquecimiento automático de datos de 200 empresas (100 BPO, 100 in-house)', 'Configurar filtros automáticos: BPO = empresas con keywords "outsourcing", "BPO partner", "contact center partner" en LinkedIn company page; In-house = keywords "internal CX team", "customer service team"', 'Usar ChatGPT/Claude API integrado en Clay para generar mensajes personalizados automáticamente para cada segmento basado en su profile data', 'Lanzar automated outreach sequence (3 touchpoints) via LinkedIn automation tool (Phantombuster o Waalaxy - €200/mes)', 'Trackear engagement signals automáticamente: profile views, message opens, link clicks, content downloads, reply sentiment (usar Gong.io o similar para sentiment analysis si responden)', 'Usar herramientas de buyer intent data (Clearbit Reveal gratis trial o 6sense) para detectar qué segmento muestra más señales de compra activa', 'Dashboard en Google Sheets/Airtable con AI-generated insights: engagement score por segmento, time-to-response, quality signals', 'Análisis final con Claude/ChatGPT: subir toda la data y pedir análisis estadístico de qué segmento es más receptivo'],
  ...
  experiments: [{
    ...
    steps: ['Identificar 30 cuentas ideales usando Clay.com + 6sense (trial): filtros= sector prioritario según H6, tamaño (200-500 emp), tech stack (usa Zendesk/Salesforce), señales de crecimiento', 'Research profundo automatizado por cuenta: usar ChatGPT/Claude para analizar earnings calls, press releases, LinkedIn posts de executives → identificar triggers (expansión, new CX leader, funding)', 'Multi-threading inteligente: identificar 3-5 stakeholders por cuenta (CX VP, COO, CTO) usando Apollo.io enrichment automático', 'Crear "account dossier" personalizado con IA: pain points específicos, competitors que usan, métricas que les importan, triggers activos', 'Setup intent monitoring integrado: Clearbit Reveal (website visits), LinkedIn Sales Navigator alerts (job changes), Google Alerts (company news), Zapier para alertas automáticas', 'Secuencia ABM de 6 touchpoints en 4 semanas SOLO cuando hay trigger/intent signal: (1) LinkedIn personalized video (Loom), (2) Email con case study sector-específico, (3) Direct mail con ROI calculator, (4) Engage con su content, (5) Warm intro via mutual connection, (6) Executive email desde founder', 'Usar Mutiny.io trial (€500) para personalizar website cuando visitan: headline con company name, case study de su industria', 'Weekly review: engagement por cuenta, triggers detectados, ajustar messaging, acelerar hot accounts con <24h response time'],
    ...
    steps: ['Crear 12 piezas de thought leadership con IA (ChatGPT/Claude): posts sobre pain points CX (200-300 palabras) - temas: "BPO tradicional está roto", "Pure AI no funciona", "Hybrid es el futuro", "ROI del BPO 2.0"', 'Publicar 3X/semana en LinkedIn (founder + equipo): alternar entre educativos, provocativos, y data-driven. Usar Taplio free trial para optimizar timing', 'Engagement activo calculado: comentar thoughtfully en posts de CX leaders de tus 30 target accounts ABM (15 min/día)', 'Monitorear "silent buyers": LinkedIn Sales Navigator alerts + Phantombuster (€150) para trackear quién visita profile después de ver content', 'Crear "engagement scoring": comentarios (5 pts), shares (10 pts), DMs (15 pts), profile visits (3 pts) - objetivo: identificar 20+ hot accounts orgánicamente', 'NO hacer outbound directo aún - solo responder si te contactan. El objetivo: VALIDAR si messaging atrae antes de cold outreach', 'Análisis semana 6: qué temas generan más engagement, quiénes engage consistentemente, correlation entre content topics y ABM conversion'],
  ...
  experiments: [{
    ...
    steps: ['Preparar 3 "packages" visuales en Canva Pro (€150): (A) "AI-First" €2K/mes - 80% automation, supervisión humana mínima; (B) "Hybrid Excellence" €4K base + €50/ticket extra - 50/50 AI/human, lo mejor de ambos; (C) "Human-First Premium" €6K/mes - humanos con AI tools, máxima personalización', 'Dividir tus primeras 15 discovery calls en 3 grupos aleatorios de 5 - presentar un package diferente a cada grupo para medir reacción inicial y preferencias', 'En CADA call, ejecutar secuencia completa: (1) Pitch del valor → (2) Mostrar el package → (3) Van Westendorp (4 preguntas de precio: demasiado barato/excelente/caro/imposible) → (4) "De estos 3 packages, ¿cuál preferirías y por qué?" → (5) "¿Qué te preocupa del modelo híbrido?"', 'Documentar religiosamente: package mostrado, 4 precios Van Westendorp, estructura preferida final (de los 3), objeciones específicas, willingness to buy signals (1-10), sector y company size', 'Semana 3: análisis intermedio con 8+ calls - plotear curvas Van Westendorp en Excel, identificar si hay patrón por sector/size, ajustar packages si <30% eligen hybrid', 'Crear "price sensitivity matrix": correlacionar company size con precio aceptable, sector con estructura preferida, decision maker role con package choice', 'Semana 5: decisión final con 12-15 data points - optimal price range €X-Y, winning structure, feature priorities, early adopter discount strategy (si necesario)', 'Bonus: si 2+ prospects dicen "me interesa a ese precio", tienes validation real de payment intent'],
  ...
  experiments: [{
    ...
    steps: ['Setup CRM simple (HubSpot free o Notion): 5 stages → Lead, MQL, Discovery, Demo, Negotiation, Close', 'Para CADA deal que entre: timestamp fecha entrada a stage, automático o manual', 'Crear "deal card" que incluye: (1) Velocidad data (días en cada stage), (2) Stakeholder map (nombres, roles, champion/blocker), (3) Company type (BPO/In-house)', 'Weekly ritual (30 min cada viernes): actualizar todos los deals, calcular días promedio por stage', 'Identificar bottlenecks: ¿dónde se atascan los deals? ¿cuántos stakeholders causa delays?', 'Comparar BPO vs In-house: velocity, # stakeholders, complejidad decisión', 'Si un deal se estanca >2 semanas en un stage: documentar POR QUÉ (objeción, stakeholder nuevo, budget freeze, etc)', 'Al final semana 8: proyección realista de sales cycle promedio para planning'],
  ...
  experiments: [{
    ...
    steps: ['En cada discovery call, hacer 3 preguntas de proof: (1) "¿Qué necesitarías ver para firmar?" (2) "¿Han comprado CX tech antes, cómo validaron?" (3) "¿Demo suficiente, o necesitan pilot?"', 'Si mencionan pilot: mostrar 3 opciones en one-pager: Express (2 sem, €500), Standard (30 días, €1.5K), Plus (60 días, €3K) - "¿Cuál considerarías?"', 'Crear 1 case study falso pero plausible con Canva Pro (€150): "Telecom X redujo AHT 35% en 60 días" - usar en presentaciones para medir reacción', 'Cuando muestres case study: observar reacción, preguntar "¿Esto ayuda a tu confianza?" "¿Qué más necesitarías?"', 'Documentar pattern: % que pide demo only, % que necesita case study, % que requiere pilot - segmentar por company size/sector', 'Investir €350 en ejecutar 1 micro-pilot real (2 semanas, 50 tickets) con el prospect más avanzado SI aparece - aprender operationally', 'Decisión: ¿qué level de proof es standard? ¿pilot €1.5K 30 días debe ser offering?'],
  ...
  experiments: [{
    ...
    steps: ['Segmentar tus 30 cuentas ABM (H2) en 3 verticales: 10 Telecom/Utilities, 10 Healthcare, 10 Retail/E-commerce - mantener company size similar para fair comparison', 'Crear messaging ligeramente adaptado por vertical con ChatGPT (€0): pain points específicos del sector - "En Telecom vemos X", "Healthcare lucha con Y"', 'Lanzar outreach simultáneo semana 1-2 a los 3 grupos - mismo timing, mismo touchpoint sequence, solo varía sector-specific messaging', 'Trackear meticulosamente por vertical: (1) Response rate, (2) Positive vs negative responses, (3) Meetings booked, (4) SQL qualification rate, (5) Days to first response, (6) Specific objections', 'En discovery calls: hacer 2 preguntas de vertical validation: "¿Qué soluciones CX específicas de [sector] han probado?" "¿Cuál es tu mayor frustración con proveedores actuales en [pain específico del sector]?"', 'Invertir €300 en crear 3 sector-specific landing pages simples (Carrd.co €100/año permite múltiples sites) - trackear conversion rate por vertical cuando redirigen desde LinkedIn', 'Semana 3: análisis intermedio - si un vertical muestra <50% del response rate del mejor, STOP outreach en ese vertical y reasignar esfuerzo', 'Decision semana 4: vertical ganador = tu ICP primario Q1 2025. Otros verticales = expansion posterior'],
  ...
  experiments: [{
    ...
    steps: ['Preparar 2 templates de contrato simple (invertir €100 en legal review básico o usar Docusign templates)', 'Opción A: Annual con exit trimestral (90 días notice) - presentar a primeros 5 prospects', 'Opción B: Monthly sin compromiso pero +15% price premium - presentar a siguientes 5 prospects', 'En cada propuesta: observar reacción inmediata, documentar objeciones sobre términos', 'Medir: time from proposal to signature, # de objeciones de contrato, questions sobre lock-in', 'Preguntar directamente: "¿Los términos son razonables o hay algo que te preocupa?"', 'Si alguien firma: post-close quick call "¿Qué te convenció de los términos?"', 'Decisión: cuál estructura balancea mejor tu cash flow vs su comfort'],
  ...
  experiments: [{
    ...
    steps: ['En tu ABM de 30 cuentas (H2): asegúrate de tener mix de tamaños: 10 cuentas 150-300 emp, 10 cuentas 300-600, 10 cuentas 600-1200', 'Trackear engagement por tamaño: response rate, meeting acceptance, quality de conversación', 'En CADA discovery call: hacer 3 preguntas de budget authority: (1) "¿Quién aprueba compras €50K?" (2) "¿Cuántas personas involucradas?" (3) "¿Timing típico de aprobación?"', 'Documentar: company size vs # stakeholders vs tiempo decisión vs budget disponible', 'Analizar también content engagement (H2): ¿qué tamaños engage más con tus posts LinkedIn?', 'Semana 4: crear matriz simple: Tamaño | Response Rate | Stakeholders | Budget Authority | Sales Complexity Score (1-10)', 'Identificar sweet spot: donde engagement es alto PERO complejidad manejable'],
...
const App = () => {
  ...
  const getExperimentProgress = experiment => {
    ...
    const completedSteps = experiment.steps.filter((_, idx) => stepCompletion[`${experiment.name}-${idx}`]).length;
  ...
  const getHypothesisProgress = hypothesis => {
    ...
    const completedSteps = hypothesis.experiments.reduce((sum, exp) => sum + exp.steps.filter((_, idx) => stepCompletion[`${exp.name}-${idx}`]).length, 0);
    return Math.round(completedSteps / totalSteps * 100);
  };
  const getTotalProgress = () => {
    const totalSteps = hypotheses.reduce((sum, h) => sum + h.experiments.reduce((expSum, exp) => expSum + exp.steps.length, 0), 0);
    const completedSteps = Object.keys(stepCompletion).filter(key => stepCompletion[key]).length;
    return Math.round(completedSteps / totalSteps * 100);
  };
  const totalBudget = hypotheses.reduce((sum, h) => sum + h.experiments.reduce((expSum, exp) => expSum + exp.budget, 0), 0);
  const StatusBadge = ({
    status
  }) => {
  ...
  if (view === 'progress') {
    const completedSteps = Object.keys(stepCompletion).filter(key => stepCompletion[key]).length;
    const totalSteps = hypotheses.reduce((sum, h) => sum + h.experiments.reduce((expSum, exp) => expSum + exp.steps.length, 0), 0);
    return <div className="min-h-screen bg-gradient-to-br from-background to-secondary p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          <button onClick={() => setView('overview')} className="mb-6 flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors font-medium">
          ...
          <div className="bg-card rounded-2xl shadow-xl p-6 md:p-8 mb-6 border border-border">
            ...
            <div className="bg-secondary/50 rounded-xl p-4">
              ...
              <div className="w-full bg-secondary rounded-full h-4 overflow-hidden">
                <div className="bg-gradient-to-r from-primary to-primary/80 h-4 rounded-full transition-all duration-500" style={{
          ...
          <div className="space-y-4">
            ...
            return <div key={h.id} className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <div className="mb-4">
                    <div className="w-full bg-slate-200 rounded-full h-2">
                      <div className={`${colors.bg} h-2 rounded-full transition-all duration-500`} style={{
                    width: `${progress}%`
                  }} />
                    </div>
                  </div>
                    ...
                    setSelectedExperiment(exp);
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <div className="flex-1 bg-slate-200 rounded-full h-1.5">
                              <div className={`${colors.bg} h-1.5 rounded-full transition-all`} style={{
                          width: `${expProgress}%`
                        }} />
                            </div>
  ...
  if (selectedExperiment && selectedHypothesis) {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
        <div className="max-w-5xl mx-auto">
          <button onClick={() => setSelectedExperiment(null)} className="mb-6 flex items-center gap-2 text-slate-600 hover:text-slate-900">
          ...
          <div className="bg-card rounded-2xl shadow-lg p-6 md:p-8 mb-6 border border-border">
            ...
            <div className="space-y-3">
              ...
              return <div key={idx} onClick={() => toggleStep(exp.name, idx)} className={`flex gap-4 p-4 rounded-xl border-2 transition-all cursor-pointer ${isCompleted ? `${colors.light} ${colors.border} shadow-sm` : 'bg-card border-border hover:border-primary/30 hover:shadow-md'}`}>
                    <div className="flex-shrink-0 pt-0.5">
                      <div className={`w-7 h-7 rounded-full border-2 flex items-center justify-center transition-all ${isCompleted ? `${colors.bg} ${colors.border}` : 'border-muted bg-card'}`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        ...
                        <div className={`text-xs px-3 py-1 rounded-full font-medium ${isCompleted ? `${colors.light} ${colors.text}` : 'bg-secondary text-muted-foreground'}`}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card rounded-2xl shadow-lg p-6 border border-border">
              ...
              <ul className="space-y-2">
                {exp.tools.map((tool, idx) => <li key={idx} className="flex items-start gap-2 text-foreground">
  ...
  if (selectedHypothesis) {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
        <div className="max-w-6xl mx-auto">
          <button onClick={() => setSelectedHypothesis(null)} className="mb-6 flex items-center gap-2 text-slate-600 hover:text-slate-900">
            <ArrowLeft size={20} /> Volver al Overview
          </button>
          ...
          <div className={`${colors.light} rounded-xl p-8 border-2 ${colors.border} mb-6`}>
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div className="flex-1 bg-slate-200 rounded-full h-2">
                        <div className={`${colors.bg} h-2 rounded-full`} style={{
                        width: `${h.confidence}%`
                      }} />
                      </div>
                ...
                <div className="w-full bg-slate-200 rounded-full h-2">
                  <div className={`${colors.bg} h-2 rounded-full transition-all`} style={{
                  width: `${progress}%`
                }} />
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <div className="space-y-4">
              ...
              return <div key={idx} onClick={() => setSelectedExperiment(exp)} className="border-2 border-slate-200 rounded-lg p-6 hover:border-slate-400 hover:shadow-md transition-all cursor-pointer">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-4 gap-3">
              <button onClick={() => updateStatus(h.id, 'progress')} className={`p-4 rounded-lg border-2 transition-all ${status === 'progress' ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:border-blue-300'}`}>
                <Clock className="mx-auto mb-2 text-blue-600" size={24} />
                <div className="text-sm font-semibold">En Progreso</div>
              </button>
              <button onClick={() => updateStatus(h.id, 'validated')} className={`p-4 rounded-lg border-2 transition-all ${status === 'validated' ? 'border-green-500 bg-green-50' : 'border-slate-200 hover:border-green-300'}`}>
                <CheckCircle2 className="mx-auto mb-2 text-green-600" size={24} />
                <div className="text-sm font-semibold">Validada</div>
              </button>
              <button onClick={() => updateStatus(h.id, 'partial')} className={`p-4 rounded-lg border-2 transition-all ${status === 'partial' ? 'border-yellow-500 bg-yellow-50' : 'border-slate-200 hover:border-yellow-300'}`}>
                <AlertTriangle className="mx-auto mb-2 text-yellow-600" size={24} />
                <div className="text-sm font-semibold">Parcial</div>
              </button>
              <button onClick={() => updateStatus(h.id, 'invalidated')} className={`p-4 rounded-lg border-2 transition-all ${status === 'invalidated' ? 'border-red-500 bg-red-50' : 'border-slate-200 hover:border-red-300'}`}>
  ...
  if (view === 'timeline') {
    return <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
        <div className="max-w-7xl mx-auto">
          <button onClick={() => setView('overview')} className="mb-6 flex items-center gap-2 text-slate-600 hover:text-slate-900">
            <ArrowLeft size={20} /> Volver al Overview
          </button>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-3">
              ...
              const colors = colorClasses[h.color];
              return <div key={h.id} className="flex items-center justify-between p-4 rounded-lg border-2 hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-3">
                      <div className={`${colors.bg} text-white p-2 rounded-lg`}>
                        <h.icon size={20} />
                      </div>
  ...
  // Overview
  return <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-background p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        {/* Hero Header */}
        <div className="bg-gradient-to-br from-accent via-accent/90 to-accent/80 text-white rounded-2xl shadow-2xl p-8 md:p-10 mb-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg md:text-xl mb-4 font-medium">8-10 semanas | Budget: €5K</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-sm">
                <div>
                  ...
                  <div className="text-white/80">Experimentos científicos, no marketing</div>
                </div>
                <div>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <button onClick={() => setView('progress')} className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-primary/80 text-white rounded-xl hover:shadow-lg transition-all font-semibold">
            <Activity size={20} />
            Dashboard de Progreso
          </button>
          <button onClick={() => setView('timeline')} className="flex items-center gap-2 px-6 py-3 bg-card border-2 border-primary text-primary rounded-xl hover:bg-primary hover:text-white transition-all font-semibold">
            <Calendar size={20} />
            Ver Timeline
          </button>
          <button onClick={() => setView('budget')} className="flex items-center gap-2 px-6 py-3 bg-card border-2 border-accent text-accent rounded-xl hover:bg-accent hover:text-white transition-all font-semibold">
            <BarChart3 size={20} />
            Ver Presupuesto
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          const progress = getHypothesisProgress(h);
          return <div key={h.id} onClick={() => setSelectedHypothesis(h)} className={`bg-card rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all cursor-pointer border-2 ${colors.border} hover:scale-[1.02] group`}>
                <div className="flex items-start justify-between mb-4">
                ...
                <div className="mb-3">
                  ...
                  <div className="w-full bg-secondary rounded-full h-2.5 overflow-hidden">
                    <div className={`${colors.bg} h-2.5 rounded-full transition-all duration-300`} style={{
                  width: `${progress}%`
                }} />
                  </div>
                </div>
